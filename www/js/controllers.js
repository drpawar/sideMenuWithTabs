...
.controller('PlaylistsCtrl', function($scope, $state) {
  ...
  $scope.nxtpage = function(listTitle)
  {
    console.log(listTitle);
    console.log($state.current.name == 'app.playlists')
    if($state.current.name == 'app.playlists')
    {
      $state.go('app.single', {'playlistTitle':listTitle});
    }
    else
    {
      $state.go('app.home.single', {'playlistTitle':listTitle});
    }
  }
